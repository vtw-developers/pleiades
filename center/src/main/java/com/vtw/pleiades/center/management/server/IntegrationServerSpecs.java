...
public class IntegrationServerSpecs {
	
    private static final String NAME = "name";
    private static final String DESCRIPTION = "description";

	public static Specification<IntegrationServerView> filter(String name, String description) {
        return (Specification<IntegrationServerView>) ((root, query, builder) -> {
